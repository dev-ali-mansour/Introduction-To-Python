...
# You are given a list of strings fellowship and, using a dict comprehension, create a dictionary with the members of
# the list as the keys and the length of each string as the corresponding values.
